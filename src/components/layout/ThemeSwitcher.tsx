  ...
  return (
    <>
      <button
        ...
        className="fixed top-24 right-0 z-40 glass-btn p-2 rounded-l-md border-l border-t border-b hover:bg-white/20 transition-colors shadow-lg"
        style={{ position: "fixed", top: "96px", right: "0px" }}
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 z-50 w-72 glass-enhanced border-l shadow-2xl p-6 overflow-y-auto"
            >
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {presets.map((color) => (
                      ...
                      >
                        ...
                        <div
                          className={`w-full h-full rounded-full bg-${color}-500`}
                        />
                        {theme === color && (
