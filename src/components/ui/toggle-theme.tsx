...
export function ToggleTheme() {
  ...
  return (
    <motion.div
      ...
      className="bg-muted/80 inline-flex items-center overflow-hidden rounded-md border border-border/20 p-1"
      role="radiogroup"
    >
        ...
        >
          {theme === option.value && (
            <motion.div
              ...
              className="bg-background shadow-sm absolute inset-0 rounded-md border border-border/10"
            />
          )}
